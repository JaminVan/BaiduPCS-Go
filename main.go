...
import (
	...
	"github.com/Luis0001/BaiduPCS-Go/internal/pcscommand"
	"github.com/Luis0001/BaiduPCS-Go/internal/pcsconfig"
	"github.com/Luis0001/BaiduPCS-Go/internal/pcsfunctions/pcsdownload"
	_ "github.com/Luis0001/BaiduPCS-Go/internal/pcsinit"
	"github.com/Luis0001/BaiduPCS-Go/internal/pcsupdate"
	"github.com/Luis0001/BaiduPCS-Go/pcsliner"
	"github.com/Luis0001/BaiduPCS-Go/pcsliner/args"
	"github.com/Luis0001/BaiduPCS-Go/pcstable"
	"github.com/Luis0001/BaiduPCS-Go/pcsutil"
	"github.com/Luis0001/BaiduPCS-Go/pcsutil/checksum"
	"github.com/Luis0001/BaiduPCS-Go/pcsutil/converter"
	"github.com/Luis0001/BaiduPCS-Go/pcsutil/escaper"
	"github.com/Luis0001/BaiduPCS-Go/pcsutil/getip"
...
func main() {
	...
	---------------------------------------------------
	前往 https://github.com/Luis0001/BaiduPCS-Go 以获取更多帮助信息!
	前往 https://github.com/Luis0001/BaiduPCS-Go/releases 以获取程序更新信息!
	---------------------------------------------------
...
`,
	...
	百度BDUSS获取方法:
		参考这篇 Wiki: https://github.com/Luis0001/BaiduPCS-Go/wiki/关于-获取百度-BDUSS
		或者百度搜索: 获取百度BDUSS`,
			Category: "百度帐号",
			Before:   reloadFn,
			After:    saveFunc,
